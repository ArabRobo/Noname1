...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "5912122980:AAEg7ZLoMjNxR22k5mBpCfRt2J_plNonI5I")
...
# ID Channel Database
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1001735069343"))
...
# Database
DB_URI = os.environ.get("DATABASE_URL", "postgres://phjitjdh:NcfL8Bp3_Fo8IWGzkW1ggpc254XreUkq@suleiman.db.elephantsql.com/phjitjdh")

PROTECT_CONTENT = strtobool(os.environ.get("PROTECT_CONTENT", "False"))

# ID dari Channel Atau Group Untuk Wajib Subscribenya
FORCE_SUB_1 = int(os.environ.get("FORCE_SUB_1", "-1001189465364"))
FORCE_SUB_2 = int(os.environ.get("FORCE_SUB_2", "-1002085658765"))
